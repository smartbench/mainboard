...
U 1 1 58DE77E1
P 4600 3325
F 0 "#PWR106" H 4600 3075 50  0001 C CNN
...
U 1 1 58DDF24C
P 3050 4325
F 0 "#PWR105" H 3050 4175 50  0001 C CNN
...
U 1 1 58DDFE6D
P 4600 6275
F 0 "#PWR107" H 4600 6025 50  0001 C CNN
...
U 1 1 58DE33A2
P 5775 6975
F 0 "#PWR112" H 5775 6725 50  0001 C CNN
...
U 1 1 58DE341F
P 5975 6975
F 0 "#PWR113" H 5975 6725 50  0001 C CNN
...
U 1 1 59674AAB
P 7375 1575
F 0 "#PWR119" H 7375 1425 50  0001 C CNN
...
U 1 1 596A4A64
P 5575 6975
F 0 "#PWR111" H 5575 6725 50  0001 C CNN
...
U 1 1 598A074E
P 9500 1625
F 0 "#PWR120" H 9500 1475 50  0001 C CNN
...
U 1 1 598A55A1
P 7275 6275
F 0 "#PWR114" H 7275 6025 50  0001 C CNN
...
U 1 1 598A69B6
P 9525 6200
F 0 "#PWR121" H 9525 5950 50  0001 C CNN
...
U 1 1 5980F198
P 5125 1650
F 0 "#PWR109" H 5125 1500 50  0001 C CNN
...
U 1 1 5980F81B
P 5350 1650
F 0 "#PWR110" H 5350 1500 50  0001 C CNN
...
U 1 1 59938834
P 9825 4000
F 0 "#PWR122" H 9825 3750 50  0001 C CNN
F 1 "GNDD" H 9825 3850 50  0000 C CNN
...
U 1 1 59940669
P 7300 2125
F 0 "#PWR115" H 7300 1875 50  0001 C CNN
...
U 1 1 599409AA
P 7300 2525
F 0 "#PWR116" H 7300 2275 50  0001 C CNN
...
U 1 1 59940CEB
P 7300 3125
F 0 "#PWR117" H 7300 2875 50  0001 C CNN
...
U 1 1 5994102C
P 7300 3525
F 0 "#PWR118" H 7300 3275 50  0001 C CNN
...
F 2 "Pin_Headers:Pin_Header_Angled_1x02_Pitch1.27mm" H 4700 2225 50  0001 C CNN
...
U 1 1 599C8049
P 5000 2275
F 0 "#PWR108" H 5000 2025 50  0001 C CNN
F 1 "GNDD" H 5000 2125 50  0000 C CNN
...
F 2 "library:Molex_73100-0105_BNC" H 10575 1925 50  0001 C CNN
F 3 "http://www.mouser.com/ds/2/276/0731000105_RF_COAX_CONNECTORS-173050.pdf" H 10575 1925 50  0001 C CNN
F 4 "73100-0105" H 10575 1925 60  0001 C CNN "MPN"
	1    10575 1925
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 599DF839
P 10375 2800
F 0 "J102" H 10375 3200 50  0000 C CNN
F 1 "NRJ6HM-1" H 10325 2500 50  0000 C CNN
F 2 "library:NRJ6HM-1_audio_jack" H 10475 2650 50  0001 C CNN
F 3 "http://www.neutrik.us/en-us/plugs-jacks/slim-jacks/nrj6hm-1" H 10475 2650 50  0001 C CNN
	1    10375 2800
	-1   0    0    1   
$EndComp
$Sheet
...
F 2 "library:Molex_73100-0105_BNC" H 10575 1225 50  0001 C CNN
F 3 "http://www.mouser.com/ds/2/276/0731000105_RF_COAX_CONNECTORS-173050.pdf" H 10575 1225 50  0001 C CNN
F 4 "73100-0105" H 10575 1225 60  0001 C CNN "MPN"
	1    10575 1225
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 59A349F5
P 10575 1425
F 0 "#PWR124" H 10575 1175 50  0001 C CNN
...
U 1 1 59A34D3A
P 10575 2125
F 0 "#PWR125" H 10575 1875 50  0001 C CNN
...
U 1 1 59A41356
P 9875 3125
F 0 "#PWR123" H 9875 2875 50  0001 C CNN
F 1 "GNDA" H 9875 2975 50  0000 C CNN
...
CHB
Text Label 9975 2800 2    60   ~ 0
CHB
Text Label 9975 2600 2    60   ~ 0
CHA
Wire Wire Line
	9975 2700 9975 2600
Wire Wire Line
